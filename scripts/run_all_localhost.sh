...
export PROXY_IDENTITY="@@relayer_pub_01.sep-zoo"
export ZOO_TOOLS_RUNNER_DENO_BINARY_PATH="${workspaceFolder}/zoo-bin/zoo-node/zoo-tools-runner-resources/deno"
export ZOO_TOOLS_RUNNER_UV_BINARY_PATH="${workspaceFolder}/zoo-bin/zoo-node/zoo-tools-runner-resources/uv"
