...
# update_tools.sh - Tool update script for Zoo
#
# This script downloads and updates tools from the Zoo store.
...
TOOLS_JSON=$(curl -s https://store-api.zoo.ai/store/defaults)
