...
export ZOO_TOOLS_RUNNER_DENO_BINARY_PATH="/app/zoo-tools-runner-resources/deno"
export ZOO_TOOLS_RUNNER_UV_BINARY_PATH="/app/zoo-tools-runner-resources/uv"
export PATH="/app/zoo-tools-runner-resources:/root/.local/bin:$PATH"

echo "Zoo node port definitions:"
