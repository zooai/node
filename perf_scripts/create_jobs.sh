...
# It creates a specified number of jobs through the Zoo API, each containing a simulated
...
# - Access to a running Zoo API instance
#
...
# API_BASE_URL  - Base URL of the Zoo API (default: "http://127.0.0.1:9950")
