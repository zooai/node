...
# Manual publishing script for hanzo-message-primitives v3 with downgraded crypto libs
# Using older versions that match the codebase

set -e

echo "🚀 Manually publishing hanzo-message-primitives (v3 - with compatible crypto)"
echo "=============================================="

cd hanzo-libs/hanzo-message-primitives

# Create a temporary fixed Cargo.toml with older compatible versions
