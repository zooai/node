...
use zoo_message_primitives::{
    ...
    }, zoo_message::{zoo_message::ZooMessage, zoo_message_schemas::AssociatedUI}, zoo_utils::{job_scope::MinimalJobScope, zoo_time::ZooStringTime}
};
...
impl SqliteManager {
    pub fn create_new_job(
...

        {
            ...
            let current_time = ZooStringTime::generate_time_now();
    ...
    pub fn get_step_history(
        ...
        job_id: &str,
        fetch_step_history: bool,
    ) -> Result<Option<Vec<ZooMessage>>, SqliteManagerError> {
        ...
        let first_messages: Vec<ZooMessage> = messages
            .into_iter()
...
mod tests {
    ...
    use zoo_message_primitives::{
        schemas::identity::StandardIdentityType, zoo_message::zoo_message_schemas::{IdentityPermissions, JobMessage, MessageSchemaType}, zoo_utils::{
            encryption::{unsafe_deterministic_encryption_keypair, EncryptionMethod}, zoo_message_builder::ZooMessageBuilder, signatures::unsafe_deterministic_signature_keypair
        }
    };
    ...
    async fn test_get_job_with_messages() {
        ...
        for i in 1..=3 {
            ...
            .unwrap();
            messages.push(zoo_message.clone());

            db.unsafe_insert_inbox_message(&zoo_message, None, None)
                .await
                .unwrap();
