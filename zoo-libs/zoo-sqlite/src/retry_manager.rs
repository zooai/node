...
use rusqlite::params;
use zoo_message_primitives::{schemas::retry::RetryMessage, zoo_message::zoo_message::ZooMessage};
...
impl SqliteManager {
    ...
    pub fn remove_message_from_retry(&self, message: &ZooMessage) -> Result<(), SqliteManagerError> {
