...
impl LibP2PProxy {
    pub async fn new(
        ...
        let registry = ZooRegistry::new(&rpc_url, &contract_address, None)
            .await
        ...
        let encryption_secret_key = encryption_secret_key
            .or_else(|| {
                ...
                zoo_message_primitives::zoo_utils::encryption::string_to_encryption_static_key(&key).ok()
            })
        ...
        let node_name = ZooName::new(node_name)
