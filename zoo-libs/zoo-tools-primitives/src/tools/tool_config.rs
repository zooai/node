...
impl ToolConfig {
    ...
    /// Generates the zoo_db_key that this header is stored at for the given toolkit_name
    pub fn zoo_db_key(&self, toolkit_name: &str) -> String {
        ...
        if let Some(obj) = value.as_object() {
            ...
            Some(OAuth {
                ...
                authorization_url: oauth_obj
                    ...
                    .and_then(|v| v.as_str())
                    .unwrap_or("https://secrets.zoo.ngo/redirect")
                    .to_string(),
...
mod tests {
    ...
    fn test_oauth_from_value_with_defaults() {
        ...
        assert_eq!(oauth.redirect_url, "https://secrets.zoo.ngo/redirect");
