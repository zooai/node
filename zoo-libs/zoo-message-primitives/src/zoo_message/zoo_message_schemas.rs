use crate::schemas::zoo_tools::DynamicToolType;
...
use crate::zoo_utils::job_scope::MinimalJobScope;
...
use super::zoo_message::{NodeApiData, ZooMessage};
...
impl MessageSchemaType {
    pub fn from_str(s: &str) -> Option<Self> {
        match s {
            ...
            "SetZooTool" => Some(Self::SetZooTool),
            "ListAllZooTools" => Some(Self::ListAllZooTools),
            "GetZooTool" => Some(Self::GetZooTool),
            "SearchZooTool" => Some(Self::SearchZooTool),
    ...
    pub fn to_str(&self) -> &'static str {
        match self {
            ...
            Self::SetZooTool => "SetZooTool",
            Self::ListAllZooTools => "ListAllZooTools",
            Self::GetZooTool => "GetZooTool",
            Self::SearchZooTool => "SearchZooTool",
