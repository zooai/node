...
pub struct ZooToolOffering {
    pub tool_key: String,
    pub usage_type: UsageType,
    pub meta_description: Option<String>,
}

impl ZooToolOffering {
...
mod tests {
    ...
    #[test]
    fn test_zoo_tool_offering_to_json() {
        let offering = ZooToolOffering {
    ...
    #[test]
    fn test_zoo_tool_offering_from_json() {
        let json = r#"
        {
            "tool_key": "test_tool",
            "usage_type": {
        ...
        let offering: ZooToolOffering = serde_json::from_str(json).expect("Failed to convert from JSON");
