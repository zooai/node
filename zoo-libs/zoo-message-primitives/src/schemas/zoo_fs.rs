...
pub struct ZooFileChunkEmbedding {
...
/// A struct that holds a collection of `ZooFileChunk`.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub struct ZooFileChunkCollection {
    /// A set of chunks related to a parsed file.
    pub chunks: Vec<ZooFileChunk>,
    /// A map of parsed file IDs to their associated paths.
    pub paths: Option<HashMap<i64, ZooPath>>,
}

impl ZooFileChunkCollection {
