...
use super::{
    llm_message::{DetailedFunctionCall, LlmMessage}, zoo_fs::ZooFileChunkCollection, subprompts::{SubPrompt, SubPromptAssetContent, SubPromptAssetDetail, SubPromptAssetType, SubPromptType}
};
...
impl Prompt {
    ...
    pub fn add_ret_node_content(
        &mut self,
        retrieved_node: ZooFileChunkCollection,
        prompt_type: SubPromptType,
        priority_value: u8,
    ) {
    ...
    pub fn add_step_history(&mut self, history: Vec<ZooMessage>, priority_value: u8) {
