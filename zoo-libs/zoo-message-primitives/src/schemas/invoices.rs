...
use super::{
    zoo_name::ZooName, zoo_tool_offering::{ZooToolOffering, UsageTypeInquiry}, tool_router_key::ToolRouterKey, wallet_mixed::PublicAddress
};
...
pub struct Invoice {
    ...
    pub provider_name: ZooName,
    pub requester_name: ZooName,
    pub usage_type_inquiry: UsageTypeInquiry,
    pub zoo_offering: ZooToolOffering,
...
impl InvoiceRequest {
    pub fn validate_and_convert_tool_key(&self, node_name: &ZooName) -> Result<String, InvoiceError> {
