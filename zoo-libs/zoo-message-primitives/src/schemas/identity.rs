...
use crate::zoo_message::zoo_message_schemas::IdentityPermissions;
use crate::zoo_utils::encryption::{encryption_public_key_to_string, encryption_public_key_to_string_ref};
use crate::zoo_utils::signatures::{signature_public_key_to_string, signature_public_key_to_string_ref};
...
impl Identity {
    ...
    pub fn get_zoo_name(&self) -> ZooName {
        match self {
...
pub struct DeviceIdentity {
    // This would include the profile name e.g. @@Alice.zoo/profileName/myPhone
    pub full_identity_name: ZooName,
    pub node_encryption_public_key: EncryptionPublicKey,
    pub node_signature_public_key: VerifyingKey,
