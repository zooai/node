...
use super::zoo_name::{ZooName, ZooNameError};
use crate::zoo_message::zoo_message::{MessageBody, ZooMessage};
...
impl fmt::Display for InboxNameError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            InboxNameError::ZooNameError(ref err) => std::fmt::Display::fmt(err, f),
...
impl From<ZooNameError> for InboxNameError {
    fn from(error: ZooNameError) -> Self {
        InboxNameError::ZooNameError(error)
    }
}
...
impl InboxName {
    pub fn new(inbox_name: String) -> Result<Self, InboxNameError> {
        ...
        if parts[0] == "inbox" {
            ...
            for part in &parts[1..parts.len() - 1] {
                if !ZooName::is_fully_valid(part.to_string()) {
                    return Err(InboxNameError::InvalidFormat(inbox_name.clone()));
                }
                match ZooName::new(part.to_string()) {
    ...
    pub fn from_message(message: &ZooMessage) -> Result<InboxName, InboxNameError> {
        match &message.body {
    ...
    pub fn has_creation_access(&self, identity_name: ZooName) -> Result<bool, InboxNameError> {
    ...
    pub fn has_sender_creation_access(&self, message: ZooMessage) -> Result<bool, InboxNameError> {
        match ZooName::from_zoo_message_using_sender_subidentity(&message) {
            Ok(zoo_name) => self.has_creation_access(zoo_name),
            Err(_) => Ok(false),
        }
    }
    ...
    pub fn get_regular_inbox_name_from_params(
        ...
        let sender_name = ZooName::new(sender_full.clone())
            .map_err(|_| ZooNameError::InvalidNameFormat(sender_full.to_string()))?;
        let recipient_name = ZooName::new(recipient_full.clone())
            .map_err(|_| ZooNameError::InvalidNameFormat(recipient_full.to_string()))?;
...
mod tests {
    use crate::{
        zoo_message::{
            zoo_message::{
                ExternalMetadata, InternalMetadata, MessageBody, MessageData, NodeApiData, ZooBody, ZooData,
                ZooVersion,
            },
            zoo_message_schemas::MessageSchemaType,
        },
    ...
    fn valid_inbox_names() {
        let valid_names = vec![
            "inbox::@@node.zoo::true",
            "inbox::@@node1.zoo/subidentity::false",
            "inbox::@@node.sep-zoo/subidentity::true",
            "inbox::@@alice.zoo/profileName/agent/myChatGPTAgent::true",
            "inbox::@@alice.zoo/profileName/device/myPhone::true",
            "inbox::@@node1.zoo/subidentity::@@node2.zoo/subidentity2::false",
            "inbox::@@node1.zoo/subidentity::@@node2.zoo/subidentity::@@node3.zoo/subidentity2::false",
        ];
    ...
    fn invalid_inbox_names() {
        let invalid_names = vec![
            "@@node1.zoo::false",
            "inbox::@@node1.zoo::falsee",
            "@@node1.zoo",
            "inbox::@@node1.zoo",
            "inbox::node1::false",
            "inbox::node1.zoo::false",
            "inbox::@@node1::false",
            "inbox::@@node1.zoo//subidentity::@@node2.zoo::false",
    ...
    fn test_from_inbox_name() {
        let inbox_name = "inbox::@@node1.zoo/subidentity::@@node2.zoo/subidentity2::true".to_string();
    ...
    fn test_from_message() {
        let mock_message = ZooMessage {
            body: MessageBody::Unencrypted(ZooBody {
                message_data: MessageData::Unencrypted(ZooData {
                ...
                internal_metadata: InternalMetadata {
                    ...
                    inbox: "inbox::@@node1.zoo/subidentity::@@node2.zoo/subidentity2::true".into(),
                    signature: "".into(),
            ...
            external_metadata: ExternalMetadata {
                sender: "@@node2.zoo".into(),
                recipient: "@@node1.zoo".into(),
        ...
        match &manager {
            InboxName::RegularInbox { value, .. } => assert_eq!(
                value,
                "inbox::@@node1.zoo/subidentity::@@node2.zoo/subidentity2::true"
            ),
            _ => panic!("Expected RegularInbox variant"),
        }
    }
        ...
        let mock_message = ZooMessage {
            body: MessageBody::Unencrypted(ZooBody {
                ...
                internal_metadata: InternalMetadata {
                    sender_subidentity: "".into(),
                    recipient_subidentity: "".into(),
                    inbox: "1nb0x::@@node1.zoo/subidentity::@@node2.zoo/subidentity2::truee".into(),
                    signature: "".into(),
                    encryption: EncryptionMethod::None,
                    node_api_data: None,
                },
    ...
    fn test_get_inbox_name_from_params_valid() {
        let sender = "@@sender.zoo".to_string();
        let sender_subidentity = "subidentity".to_string();
        let recipient = "@@recipient.zoo".to_string();
    ...
    fn test_has_creation_access() {
        let manager = InboxName::new(
            "inbox::@@node1.zoo/subidentity::@@node2.zoo::@@node3.zoo/subidentity3::true".to_string(),
        )
        .unwrap();

        let identity_name = ZooName::new("@@node1.zoo/subidentity".to_string()).unwrap();
        let identity_name_2 = ZooName::new("@@node2.zoo/subidentity".to_string()).unwrap();
        ...
        let mock_message = ZooMessage {
            body: MessageBody::Unencrypted(ZooBody {
                ...
                internal_metadata: InternalMetadata {
                    ...
                    recipient_subidentity: "".into(),
                    inbox: "inbox::@@node1.zoo::@@node2.zoo/subidentity2::true".into(),
                    signature: "".into(),
                    encryption: EncryptionMethod::None,
        ...
        let mock_message = ZooMessage {
            body: MessageBody::Unencrypted(ZooBody {
                ...
                internal_metadata: InternalMetadata {
                    ...
                    recipient_subidentity: "".into(),
                    inbox: "inbox::@@node1.zoo::@@node2.zoo::true".into(),
                    signature: "".into(),
                    encryption: EncryptionMethod::None,
                    node_api_data: Some(NodeApiData {
