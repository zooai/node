use crate::{
    zoo_message::{zoo_message::ZooMessage, zoo_message_schemas::AssociatedUI},
...
pub struct Job {
    ...
    /// A list of messages that were generated as output from the latest Job step
    pub step_history: Vec<ZooMessage>,
