...
mod tests {
    ...
    use crate::zoo_message::zoo_message_schemas::MessageSchemaType;
    use crate::zoo_utils::encryption::EncryptionMethod;
    use crate::zoo_utils::zoo_message_builder::ZooMessageBuilder;
    use ed25519_dalek::SigningKey;
    use x25519_dalek::{PublicKey as EncryptionPublicKey, StaticSecret as EncryptionStaticKey};

    fn generate_zoo_message(
        content: String,
    ...
    fn test_to_prompt() {
        ...
        let origin_destination_identity_name = "@@node1.zoo".to_string();
        let timestamp = "2023-07-02T20:53:34.811Z".to_string();

        // Generate the ZooMessage using the helper function
        let message = generate_zoo_message(
