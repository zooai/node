...
use super::{search_mode::VectorSearchMode, zoo_path::ZooPath};

#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, ToSchema)]
pub struct MinimalJobScope {
    pub vector_fs_items: Vec<ZooPath>, // TODO: rename this to non-vector-fs-items
    pub vector_fs_folders: Vec<ZooPath>,
