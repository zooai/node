use crate::{schemas::zoo_name::ZooName, zoo_message::zoo_message_schemas::MessageMetadata};
...
use super::{
    ...
    zoo_message_builder::{ZooMessageBuilder, ZooNameString},
    zoo_path::ZooPath,
};
...
impl ZooMessageBuilder {
    ...
    pub fn request_code_registration(
        ...
        ZooMessageBuilder::create_custom_zoo_message_to_node(
    ...
    pub fn initial_registration_with_no_code_for_device(
        ...
        ZooMessageBuilder::new(my_device_encryption_sk, my_device_signature_sk, my_device_encryption_pk)
            .message_raw_content(body)
            .body_encryption(EncryptionMethod::None)
            .internal_metadata_with_schema(
                sender_subidentity,
    ...
    #[allow(clippy::too_many_arguments)]
    #[allow(dead_code)]
    pub fn create_custom_zoo_message_to_node<T: Serialize>(
        my_subidentity_encryption_sk: EncryptionStaticKey,
        my_subidentity_signature_sk: SigningKey,
        receiver_public_key: EncryptionPublicKey,
        data: T,
