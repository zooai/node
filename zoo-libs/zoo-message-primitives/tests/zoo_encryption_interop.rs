...
mod tests {
    ...
    use zoo_message_primitives::{
        zoo_message::zoo_message::{EncryptedZooBody, EncryptedZooData, MessageBody, MessageData},
        zoo_utils::encryption::{string_to_encryption_public_key, unsafe_deterministic_encryption_keypair},
    };
    ...
    fn test_decrypt_message_body_from_typescript_lib() {
        ...
        let encrypted_data = EncryptedZooBody {
    ...
    fn test_decrypt_message_data_from_typescript_lib() {
        ...
        let encrypted_data = EncryptedZooData {
            content: format!("encrypted:{}", encrypted_content),
        };
    ...
    //     let sender = "@@localhost.zoo".to_string();
    //     let recipient = "@@localhost.zoo".to_string();
    //     let sender_subidentity = "main".to_string();

    //     let get_all_inboxes_message_result = ZooMessageBuilder::get_all_inboxes_for_profile(
