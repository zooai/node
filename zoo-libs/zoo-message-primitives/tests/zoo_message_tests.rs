mod tests {
    ...
    use zoo_message_primitives::zoo_message::zoo_message_schemas::JobMessage;
    ...
    fn test_encode_decode_message() {
        ...
        let message = ZooMessageBuilder::new(
        ...
        // Decode the message
        let decoded_message = ZooMessage::decode_message_result(encoded_message).unwrap();
    ...
    fn test_serde_encode_decode_message() {
        ...
        // Deserialize the JSON string back to a ZooMessage
        let deserialized_message: ZooMessage = serde_json::from_str(&serialized_message).unwrap();
    ...
    fn test_serde_encode_decode_message_with_decode_message_result() {
        ...
        // Deserialize the JSON string back to a ZooMessage using decode_message_result
        let deserialized_message = ZooMessage::decode_message_result(serialized_message_bytes).unwrap();
    ...
    fn test_serialize_deserialize_job_message_with_files() {
        // Create a sample JobMessage with a ZooPath in files
        let job_message = JobMessage {
            job_id: "test_job_id".to_string(),
            ...
            metadata: None,
            tool_key: Some("tool_key".to_string()),
            fs_files_paths: vec![ZooPath::new("/path/to/file")],
