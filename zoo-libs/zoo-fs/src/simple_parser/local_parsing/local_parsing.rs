...
//         match &source_base {
//             VRSourceReference::None => Err(ZooFsError::UnsupportedFileType(file_name.to_string())),
//             VRSourceReference::Standard(source) => match source {
//                 SourceReference::Other(_) => Err(ZooFsError::UnsupportedFileType(file_name.to_string())),
...
//                     | SourceFileType::Zoo(_) => Err(ZooFsError::UnsupportedFileType(file_name.to_string())),
...
//                         _ => Err(ZooFsError::UnsupportedFileType(file_name.to_string())),
//                     },
//                 },
//                 SourceReference::ExternalURI(_) => Err(ZooFsError::UnsupportedFileType(file_name.to_string())),
//             },
//             VRSourceReference::Notarized(_) => Err(ZooFsError::UnsupportedFileType(file_name.to_string())),
//         }
//     }
// }
