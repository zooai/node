...
use super::file_parser_helper::ZooFileParser;
...
impl ZooFileParser {
    ...
    ) -> Pin<Box<dyn Future<Output = Result<Vec<TextGroup>, ZooFsError>> + Send>> {
        Box::pin(async move {
                    ...
                    match result {
                        ...
                        Err(e) => {
                            ...
                            if max_batch_size > 5 {
                                ...
                                return Err(ZooFsError::FailedEmbeddingGeneration(e.to_string()));
                            }
                        }
                    }
                }
