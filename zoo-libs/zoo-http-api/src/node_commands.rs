...
use zoo_message_primitives::{
    ...
    }, zoo_utils::job_scope::MinimalJobScope
};

use zoo_tools_primitives::tools::{
    mcp_server_tool::MCPServerTool, zoo_tool::{ZooTool, ZooToolHeader, ZooToolWithAssets}, tool_config::OAuth, tool_playground::ToolPlayground, tool_types::{OperatingSystem, RunnerType}
};
// use crate::{
//     prompts::custom_prompt::CustomPrompt, tools::zoo_tool::{ZooTool, ZooToolHeader}, wallet::{
...
pub enum NodeCommand {
    ...
    // Command to make the node send a `ZooMessage` in an onionized (i.e., anonymous and encrypted) way.
    ...
    // Command to make the node use a registration code encapsulated in a `ZooMessage`. The sender will receive
    // the result.
    ...
    V2ApiListAllZooTools {
        bearer: String,
        category: Option<String>,
        res: Sender<Result<Value, APIError>>,
    },
    V2ApiListAllMcpZooTools {
        category: Option<String>,
        res: Sender<Result<Value, APIError>>,
    },
    V2ApiListAllNetworkZooTools {
        bearer: String,
        res: Sender<Result<Value, APIError>>,
    },
    V2ApiListAllZooToolsVersions {
        bearer: String,
        res: Sender<Result<Value, APIError>>,
    },
    V2ApiSetZooTool {
    ...
    V2ApiGetToolOffering {
        ...
        res: Sender<Result<ZooToolOffering, APIError>>,
    },
    ...
    V2ApiGetAllToolOfferings {
        bearer: String,
        res: Sender<Result<Vec<ZooToolHeader>, APIError>>,
    },
    V2ApiSetToolOffering {
        bearer: String,
        tool_offering: ZooToolOffering,
        res: Sender<Result<ZooToolOffering, APIError>>,
    },
