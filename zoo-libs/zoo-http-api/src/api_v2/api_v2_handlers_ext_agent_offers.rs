...
use zoo_message_primitives::schemas::{
    zoo_tool_offering::{ZooToolOffering, ToolPrice, UsageType}, wallet_mixed::{Asset, NetworkIdentifier}, x402_types::PaymentRequirements
};
...
pub struct SetToolOfferingRequest {
    pub tool_offering: ZooToolOffering,
}
...
#[utoipa::path(
    post,
    path = "/v1/node/set_tool_offering",
...
#[utoipa::path(
    post,
    path = "/v1/node/get_tool_offering",
    request_body = GetToolOfferingRequest,
    responses(
        (status = 200, description = "Successfully retrieved tool offering", body = ZooToolOffering),
        (status = 400, description = "Bad request", body = APIError),
...
#[utoipa::path(
    post,
    path = "/v1/node/remove_tool_offering",
...
#[utoipa::path(
    get,
    path = "/v1/node/get_all_tool_offerings",
    responses(
        (status = 200, description = "Successfully retrieved all tool offerings", body = Vec<ZooToolOffering>),
        (status = 500, description = "Internal server error", body = APIError)
    )
)]
...
#[utoipa::path(
    post,
    path = "/v1/node/get_tool_with_offering",
...
#[utoipa::path(
    get,
    path = "/v1/node/get_tools_with_offerings",
    responses(
...
#[utoipa::path(
    post,
    path = "/v1/node/get_agent_network_offering",
...
#[openapi(
    ...
    components(
        schemas(ZooToolOffering, APIError, GetToolOfferingRequest, UsageType, ToolPrice, PaymentRequirements, Asset, NetworkIdentifier,
