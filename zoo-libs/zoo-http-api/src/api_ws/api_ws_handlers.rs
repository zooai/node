...
//! and the implementation is low-level and very coupled to the Zoo Node.
...
use zoo_message_primitives::zoo_utils::zoo_logging::{
    zoo_log, ZooLogLevel, ZooLogOption,
};
...
impl WebSocketProxy {
    ...
    /// Logs info message
    fn log_info(msg: &str) {
        zoo_log(ZooLogOption::WsAPI, ZooLogLevel::Info, msg);
    }

    /// Logs error message
    fn log_error(msg: &str) {
        zoo_log(ZooLogOption::WsAPI, ZooLogLevel::Error, msg);
    }
}
