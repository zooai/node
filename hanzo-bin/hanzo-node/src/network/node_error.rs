...
impl From<HanzoMessageError> for NodeError {
    fn from(err: HanzoMessageError) -> NodeError {
        NodeError {
            message: format!("{}", err),
        }
    }
...
impl From<HanzoNameError> for NodeError {
    fn from(error: HanzoNameError) -> Self {
        NodeError {
            message: format!("HanzoNameError: {}", error),
        }
    }
}
