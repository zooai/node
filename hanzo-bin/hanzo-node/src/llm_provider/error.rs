...
pub enum LLMProviderError {
    ...
    HanzoMessage(HanzoMessageError),
    ...
    HanzoBackendInvalidAuthentication(String),
    HanzoBackendInvalidConfiguration(String),
    HanzoBackendInferenceLimitReached(String),
    HanzoBackendAIProviderError(String),
    HanzoBackendUnexpectedStatusCode(u64),
    HanzoBackendUnexpectedError(String),
    ...
    HanzoMessageBuilderError(String),
    TokenLimit(String),
...
impl fmt::Display for LLMProviderError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            LLMProviderError::HanzoDB(err) => write!(f, "Hanzo DB error: {}", err),
            ...
            LLMProviderError::HanzoNameError(err) => write!(f, "HanzoName error: {}", err),
            ...
            LLMProviderError::HanzoMessage(err) => write!(f, "HanzoMessage error: {}", err),
            ...
            LLMProviderError::HanzoBackendInvalidAuthentication(s) => write!(f, "Hanzo Backend Invalid Authentication: {}", s),
            LLMProviderError::HanzoBackendInvalidConfiguration(s) => write!(f, "Hanzo Backend Invalid configuration: {}", s),
            LLMProviderError::HanzoBackendInferenceLimitReached(s) => write!(f, "Hanzo Backend Inference Limit Reached: {}", s),
            LLMProviderError::HanzoBackendAIProviderError(s) => write!(f, "Hanzo Backend AI Provider Error: {}", s),
            LLMProviderError::HanzoBackendUnexpectedStatusCode(code) => write!(f, "Hanzo Backend Unexpected Status Code: {}", code),
            LLMProviderError::HanzoBackendUnexpectedError(e) => write!(f, "Hanzo Backend Unexpected Error: {}", e),
            ...
            LLMProviderError::HanzoMessageBuilderError(s) => write!(f, "{}", s),
...
impl LLMProviderError {
    ...
    pub fn to_error_message(&self) -> String {
        let error_name = match self {
            ...
            LLMProviderError::HanzoDB(_) => "HanzoDB",
            LLMProviderError::HanzoNameError(_) => "HanzoNameError",
            ...
            LLMProviderError::HanzoMessage(_) => "HanzoMessage",
            ...
            LLMProviderError::HanzoBackendInvalidAuthentication(_) => "HanzoBackendInvalidAuthentication",
            LLMProviderError::HanzoBackendInvalidConfiguration(_) => "HanzoBackendInvalidConfiguration",
            LLMProviderError::HanzoBackendInferenceLimitReached(_) => "HanzoBackendInferenceLimitReached",
            LLMProviderError::HanzoBackendAIProviderError(_) => "HanzoBackendAIProviderError",
            LLMProviderError::HanzoBackendUnexpectedStatusCode(_) => "HanzoBackendUnexpectedStatusCode",
            LLMProviderError::HanzoBackendUnexpectedError(_) => "HanzoBackendUnexpectedError",
            ...
            LLMProviderError::HanzoMessageBuilderError(_) => "HanzoMessageBuilderError",
...
impl std::error::Error for LLMProviderError {
    fn source(&self) -> Option<&(dyn std::error::Error + 'static)> {
        match self {
            ...
            LLMProviderError::HanzoDB(err) => Some(err),
            LLMProviderError::HanzoNameError(err) => Some(err),
            _ => None,
        }
    }
}
...
impl From<SqliteManagerError> for LLMProviderError {
    fn from(err: SqliteManagerError) -> LLMProviderError {
        LLMProviderError::HanzoDB(err)
    }
}

impl From<HanzoNameError> for LLMProviderError {
    fn from(err: HanzoNameError) -> LLMProviderError {
        LLMProviderError::HanzoNameError(err)
    }
}
...
impl From<HanzoMessageError> for LLMProviderError {
    fn from(error: HanzoMessageError) -> Self {
        LLMProviderError::HanzoMessage(error)
    }
}
...
impl From<HanzoFsError> for LLMProviderError {
    fn from(err: HanzoFsError) -> LLMProviderError {
        LLMProviderError::IO(err.to_string())
    }
}
