...
impl GenericInferenceChain {
    ...
    pub async fn start_chain(
        ...
        */
        ...
        if tools_allowed && web_search_enabled {
            ...
            let code_execution_processor_tool_key = "local:::__official_hanzo:::hanzo_python_code_execution";
        ...
        let custom_system_prompt = {
            ...
            if tools_allowed && web_search_enabled {
                ...
                let web_search_instructions = format!(
                    ...
                    ## hanzo_python_code_execution
                    Use the hanzo_python_code_execution tool to execute Python code if a user asks a question that can be resolved with code of if explicitly asked to do so.
                    ...
                    - Always save into the user's home path with `hanzo_local_support.get_home_path()`. Example:
                    ```python
    ...
    fn extract_tools_from_conversation_history(step_history: &[HanzoMessage], max_messages: usize) -> Vec<String> {
