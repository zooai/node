...
#[utoipa::path(
    get,
    path = "/v1/list_all_network_hanzo_tools",
    responses(
...
#[utoipa::path(
    get,
    path = "/v1/resolve_hanzo_file_protocol",
    params(
...
#[utoipa::path(
    get,
    path = "/v1/list_all_hanzo_tools_versions",
    responses(
...
#[utoipa::path(
    get,
    path = "/v1/get_hanzo_tool_metadata",
    params(
