        ...
        if let Some(obj) = value.as_object() {
            ...
            Some(OAuth {
                ...
                authorization_url: oauth_obj
                    ...
                    .and_then(|v| v.as_str())
                    .unwrap_or("https://secrets.hanzo.ai/redirect")
                    .to_string(),
...
mod tests {
                ...
                ToolConfig::BasicConfig(config) => {
                    ...
                    assert_eq!(
                        ...
                        Some(serde_json::Value::String(
                            "63d35ff6068c3103ccd1227546935111".to_string()
                        ))
                    );
                }
    ...
    fn test_oauth_from_value_with_defaults() {
        ...
        assert_eq!(oauth.redirect_url, "https://secrets.hanzo.ai/redirect");
