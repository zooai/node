...
use hanzo_messages::{
    ...
    hanzo_utils::{encryption::encryption_public_key_to_string, signatures::signature_public_key_to_string},
};
    ...
    pub async fn new(
        ...
        let encryption_secret_key = encryption_secret_key
            .or_else(|| {
                ...
                hanzo_messages::hanzo_utils::encryption::string_to_encryption_static_key(&key).ok()
            })
