...
use rusqlite::params;
use hanzo_message_primitives::{schemas::retry::RetryMessage, hanzo_message::hanzo_message::HanzoMessage};
...
impl SqliteManager {
    ...
    pub fn remove_message_from_retry(&self, message: &HanzoMessage) -> Result<(), SqliteManagerError> {
