...
pub struct HanzoFileChunkEmbedding {
...
/// A struct that holds a collection of `HanzoFileChunk`.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub struct HanzoFileChunkCollection {
    /// A set of chunks related to a parsed file.
    pub chunks: Vec<HanzoFileChunk>,
    /// A map of parsed file IDs to their associated paths.
    pub paths: Option<HashMap<i64, HanzoPath>>,
}

impl HanzoFileChunkCollection {
