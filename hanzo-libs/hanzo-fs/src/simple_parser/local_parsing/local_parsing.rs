...
//         match &source_base {
//             VRSourceReference::None => Err(HanzoFsError::UnsupportedFileType(file_name.to_string())),
//             VRSourceReference::Standard(source) => match source {
//                 SourceReference::Other(_) => Err(HanzoFsError::UnsupportedFileType(file_name.to_string())),
...
//                     | SourceFileType::Hanzo(_) => Err(HanzoFsError::UnsupportedFileType(file_name.to_string())),
...
//                         _ => Err(HanzoFsError::UnsupportedFileType(file_name.to_string())),
//                     },
//                 },
//                 SourceReference::ExternalURI(_) => Err(HanzoFsError::UnsupportedFileType(file_name.to_string())),
//             },
//             VRSourceReference::Notarized(_) => Err(HanzoFsError::UnsupportedFileType(file_name.to_string())),
//         }
//     }
// }
