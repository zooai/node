...
//             zoo_logging::init_default_tracing,
...
//         db::{db_cron_task::CronTask, ZooDB},
...
//     //     setup();
//     //     let db = Arc::new(ZooDB::new("db_tests/").unwrap());
...
//     //     let node_profile_name = ZooName::new("@@localhost.zoo/main".to_string()).unwrap();
//     //     let agent_id = "agent_id1".to_string();
//     //     let agent_name =
//     //         ZooName::new(format!("{}/agent/{}", node_profile_name.clone(), agent_id.clone()).to_string()).unwrap();
