...
use zoo_message_primitives::schemas::llm_providers::serialized_llm_provider::{
...
use zoo_tools_primitives::tools::zoo_tool::{ZooTool, ZooToolWithAssets};
...
fn tool_duplicate_tests() {
    ...
    run_test_one_node_network(|env| {
        Box::pin(async move {
            ...
            let tool_key_name: String = "local:::__node1_test_sep_zoo:::demo_tool".to_string();
            println!("Creating tool");
            {
                let tool_router_key = ToolRouterKey::new(
                    "local".to_string(),
                    "@@node1_test.sep-zoo".to_string(),
                    "demo_tool".to_string(),
                    None,
                );
                ...
                let deno = DenoTool {
                    ...
                    author: "@@node1_test.sep-zoo".to_string(),
            ...
            let tool_key_name_duplicate = {
                ...
                // "tool_router_key": String("local:::__node1_test_sep_zoo:::demo_tool_20250331_163342"), "version":
                // String("1.0.0")}
                fork_result
                    .get("tool_router_key")
                    .unwrap()
...

            {
                ...
                assert!(result.is_ok(), "Tool fork failed");
                let fork_result = result.unwrap();
                // Get tool offering result: Ok(Object {"assets": Null, "code": String("console.log('Hello, Deno 1!');"), "job_id": String("jobid_9b3a96e9-7cf3-43b6-9306-f5acb56ca27c"), "job_id_history": Array [String("")], "language": String("typescript"), "metadata": Object {"author": String("@@node1_test.sep-zoo"), "configurations": Object {"properties": Object {"a": Object {"description": String("c"), "type": String("string")}}, "required": Array [String("a")], "type": String("object")}, "description": String("A Deno tool for testing 1"), "homepage": String("http://127.0.0.1/index.html"), "keywords": Array [String("deno"), String("test")], "name": String("demo_tool_20250331_164114"), "oauth": Null, "operating_system": Array [String("windows")], "parameters": Object {"properties": Object {"prompt": Object {"description": String("The prompt to process"), "type": String("string")}}, "required": Array [String("prompt")], "type": String("object")}, "result": Object {"properties": Null, "required": Array [], "type": String("object")}, "runner": String("only_host"), "sqlQueries": Array [], "sqlTables": Array [], "tool_set": Null, "tools": Array [String("local:::__official_zoo:::zoo_llm_prompt_processor")], "version": String("1.0.0")}, "tool_router_key": String("local:::__node1_test_sep_zoo:::demo_tool_20250331_164114")})
                ...
                // Metadata: {
                //     "author": String("@@node1_test.sep-zoo"),
                ...
                // [String("local:::__official_zoo:::zoo_llm_prompt_processor")], "version": String("1.0.0")}
                let author = metadata.get("author").unwrap().as_str().unwrap();
                eprintln!("Author: {:?}", author);
                assert_eq!(author, "@@node1_test.sep-zoo");
