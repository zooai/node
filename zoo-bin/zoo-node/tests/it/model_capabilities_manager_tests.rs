...
mod tests {
    ...
    use zoo_node::managers::model_capabilities_manager::{
    ...
    async fn test_has_capability() {
        ...
        let llm_provider_name =
            ZooName::new(format!("@@localhost.zoo/main/agent/{}", llm_provider_id.clone()).to_string())
                .unwrap();
        ...
        let manager = ModelCapabilitiesManager {
            db: db_weak,
            profile: ZooName::new("@@localhost.zoo/test_profile".to_string()).unwrap(),
    ...
    async fn test_fake_gpt_model_capabilities() {
        ...
        let agent_name =
            ZooName::new(format!("@@localhost.zoo/main/agent/{}", agent_id.clone()).to_string()).unwrap();
