...
use zoo_message_primitives::zoo_message::zoo_message_schemas::FunctionCallMetadata;
...
pub trait InferenceChainContextTrait: Send + Sync {
    ...
    fn fs_files_paths(&self) -> &Vec<ZooPath>;
...
pub struct InferenceChainResult {
    ...
    pub generated_files: Vec<ZooPath>,
}
...
impl LLMInferenceResponse {
    pub fn new(response_string: String, reasoning_content: Option<String>, json: JsonValue, function_calls: Vec<FunctionCall>, generated_files: Vec<ZooPath>, tps: Option<f64>) -> Self {
        Self {
            response_string,
            reasoning_content,
            json,
...
impl Default for MockInferenceChainContext {
    fn default() -> Self {
        ...
        let user_profile = ZooName::default_testnet_localhost();
        Self {
            user_message,
            image_files: HashMap::new(),
            video_files: HashMap::new(),
