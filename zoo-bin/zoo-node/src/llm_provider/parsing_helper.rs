...
use zoo_fs::simple_parser::file_parser_helper::ZooFileParser;
use zoo_fs::simple_parser::text_group::TextGroup;
...
impl ParsingHelper {
    ...
    pub async fn generate_description(
        ...
        let descriptions = ZooFileParser::process_groups_into_descriptions_list(text_groups, 10000, 300);
        ...
        if let Some(answer) = extracted_answer {
            ...
            let desc = ZooFileParser::process_groups_into_description(
                text_groups,
