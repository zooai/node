...
use serde_json::{self};
use zoo_message_primitives::schemas::llm_message::LlmMessage;
use zoo_message_primitives::schemas::llm_providers::serialized_llm_provider::LLMProviderInterface;
...
mod tests {
    ...
    fn test_claude_prepare_messages() {
        ...
        let llm_messages = vec![
            ...
            LlmMessage {
                role: Some("user".to_string()),
                content: Some("tell me what's the response when using zoo echo tool with: say hello".to_string()),
                name: None,
                function_call: None,
                functions: None,
                images: Some(vec![]),
        ...
        assert_eq!(messages[0]["content"], "tell me what's the response when using zoo echo tool with: say hello");
        ...
        assert_eq!(assistant_content[0]["name"], "zoo__echo");
            ...
            SubPrompt::ToolAvailable(
                ...
                serde_json::json!({
                    "function": {
                        ...
                        "tool_router_key": "local:::google_search_zoo:::google_search"
                    },
                    "type": "function"
                }),
                98,
            ...
            SubPrompt::ToolAvailable(
                ...
                serde_json::json!({
                    "function": {
                        ...
                        "tool_router_key": "local:::smart_search_zoo:::smart_search_engine"
                    },
                    "type": "function"
                }),
                97,
