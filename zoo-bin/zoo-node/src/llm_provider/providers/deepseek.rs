...
use zoo_message_primitives::schemas::llm_providers::serialized_llm_provider::{DeepSeek, LLMProviderInterface};
...
mod tests {
    ...
    fn test_deepseek_serialized_provider() {
        let provider = SerializedLLMProvider {
            ...
            name: None,
            description: None,
            full_identity_name: ZooName::new("@@test.zoo/main/agent/deepseek_test".to_string()).unwrap(),
