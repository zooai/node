...
use zoo_message_primitives::schemas::{
    zoo_name::ZooName, wallet_mixed::{Address, AddressBalanceList, Asset, Balance, PublicAddress, Transaction}, x402_types::{Network, PaymentRequirements}
};
...
pub trait CommonActions {
    ...
    fn get_balance(&self, node_name: ZooName) -> Pin<Box<dyn Future<Output = Result<f64, WalletError>> + Send>>;
