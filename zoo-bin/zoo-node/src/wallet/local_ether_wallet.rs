...
use zoo_message_primitives::schemas::wallet_complementary::WalletSource;
...
use zoo_non_rust_code::functions::ethers_wallet::create_wallet::{
    self as ethers_create_wallet, Input as EthersWalletInput
};
use zoo_non_rust_code::functions::ethers_wallet::get_balance;
use zoo_non_rust_code::functions::ethers_wallet::recover_wallet::{
    self as ethers_recover_wallet, Input as EthersRecoverInput, RecoverySource
};
use zoo_non_rust_code::functions::x402::create_payment::{self, Input};
    ...
    fn check_balances(
        ...
        Box::pin(async move {
            ...
            let eth_asset = Asset::new(
                zoo_message_primitives::schemas::wallet_mixed::AssetType::ETH,
                &network,
            )
            ...
            if let Some(usdc_asset) = Asset::new(
                zoo_message_primitives::schemas::wallet_mixed::AssetType::USDC,
                &network,
            ) {
