...
use zoo_message_primitives::schemas::{
    coinbase_mpc_config::CoinbaseMPCWalletConfig, invoices::{Invoice, Payment, PaymentStatusEnum}, zoo_name::ZooName, zoo_tool_offering::ToolPrice, wallet_complementary::{WalletRole, WalletSource}, wallet_mixed::{Asset, Balance, PublicAddress}, x402_types::Network
};
...
impl WalletManager {
    ...
    pub async fn pay_invoice(&self, invoice: Invoice, node_name: ZooName) -> Result<Payment, WalletError> {
        ...
        // Extract the asset information from zoo_offering
        let price = invoice
            .zoo_offering
    ...
    pub async fn check_balances_payment_wallet(
        &self,
        node_name: ZooName,
    ) -> Result<zoo_message_primitives::schemas::wallet_mixed::AddressBalanceList, WalletError> {
