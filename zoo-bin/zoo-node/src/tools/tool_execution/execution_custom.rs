...
pub async fn try_to_execute_rust_tool(
    ...
    // Result<bool, SqliteManagerError> { ... } in zoo_sqlite/src/zoo_tool_manager.rs

    let result = match tool_router_key {
        // TODO Keep in sync with definitions_custom.rs
        s if s == "local:::__official_zoo:::zoo_llm_map_reduce_processor" => {
        ...
        s if s == "local:::__official_zoo:::zoo_agent_prompt_processor" => {
        ...
        s if s == "local:::__official_zoo:::zoo_typescript_unsafe_processor" => {
        ...
        s if s == "local:::__official_zoo:::zoo_sqlite_query_executor" => {
        ...
        s if s == "local:::__official_zoo:::zoo_tool_config_updater" => {
        ...
        s if s == "local:::__official_zoo:::zoo_llm_prompt_processor" => {
        ...
        s if s == "local:::__official_zoo:::zoo_process_embeddings" => {
