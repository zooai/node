...
use zoo_tools_primitives::tools::{zoo_tool::ZooToolHeader, tool_output_arg::ToolOutputArg};
use std::sync::Arc;
...
impl ConfigSetupTool {
    pub fn new() -> Self {
        Self {
            tool: ZooToolHeader {
                name: "Zoo Tool Config Updater".to_string(),
...
Example usage:
{
    ...
    "config": {
            ...
            "api_secret": "some-api-secret"
                ...
                tool_router_key: "local:::__official_zoo:::zoo_tool_config_updater".to_string(),
                tool_type: "Rust".to_string(),
                formatted_tool_summary_for_ui: "Update ZooTool configurations".to_string(),
...
async fn config_update(
    ...
    match &mut tool {
        zoo_tools_primitives::tools::zoo_tool::ZooTool::Deno(deno_tool, _) => {
            deno_tool.config = new_configs;
        }
        zoo_tools_primitives::tools::zoo_tool::ZooTool::Python(python_tool, _) => {
...
",
    ...
    let message = format!(
        "The tool function command was NOT applied. To apply it, call tool 'Zoo Tool Config Updater' again with the following parameters:
'tool_router_key': {}
'config': {}",
...
mod tests {
    ...
    use zoo_tools_primitives::tools::{deno_tools::DenoTool, zoo_tool::ZooTool};
    ...
    fn test_tool_router_key() {
        ...
        assert_eq!(
            ...
            "local:::__official_zoo:::zoo_tool_config_updater"
        );
    }

    fn create_deno_tool() -> ZooTool {
        ...
        let mut initial_tool = ZooTool::Deno(
            DenoTool {
