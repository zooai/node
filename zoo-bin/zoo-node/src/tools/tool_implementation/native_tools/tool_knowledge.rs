...
use zoo_message_primitives::schemas::subprompts::SubPrompt;
...
impl KnowledgeTool {
    pub fn new() -> Self {
        Self {
            tool: ZooToolHeader {
                name: "Zoo Process Embeddings".to_string(),
...
- Collect and join processed embeddings for further analysis."#
                    .to_string(),
                tool_router_key: "local:::__official_zoo:::zoo_process_embeddings".to_string(),
...
mod tests {
    ...
    fn test_tool_router_key() {
        ...
        assert_eq!(
            ...
            "local:::__official_zoo:::zoo_process_embeddings"
        );
    }
}
