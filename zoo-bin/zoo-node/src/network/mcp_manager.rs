...
use zoo_http_api::api_v2::api_v2_handlers_mcp_servers::AddMCPServerRequest;
use zoo_message_primitives::schemas::mcp_server::MCPServerType;
use zoo_tools_primitives::tools::{
    mcp_server_tool::MCPServerTool, parameters::{Parameters, Property}, zoo_tool::ZooTool, tool_config::ToolConfig, tool_output_arg::ToolOutputArg, tool_types::ToolResult
};
use toml::Table;

/// Converts an rmcp Tool to a ZooTool::MCPServer
pub fn convert_to_zoo_tool(
    tool: &Tool,
    server_name: &str,
    server_id: &str,
    ...
    // Return the ZooTool
    ZooTool::MCPServer(mcp_tool, true)
}
...
pub mod tests_mcp_manager {
    ...
    fn test_convert_to_zoo_tool() {
        ...
        let zoo_tool = convert_to_zoo_tool(
            tool,
            server_name,
            server_id,
            server_command_hash,
        ...
        if let ZooTool::MCPServer(mcp_tool, enabled) = zoo_tool {
            ...
            panic!("Expected ZooTool::MCPServer variant");
        }
    }
