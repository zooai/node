        ...
        if enabled {
            ...
            if let Some(ref existing_tunnel) = *active_tunnel_guard {
                ...
                let authtoken_for_status = match db.read_ngrok_auth_token() {
                    ...
                    Err(e) => {
                        zoo_message_primitives::zoo_utils::zoo_logging::zoo_log(
                            zoo_message_primitives::zoo_utils::zoo_logging::ZooLogOption::Node,
                            zoo_message_primitives::zoo_utils::zoo_logging::ZooLogLevel::Info,
            ...
            *active_tunnel_guard = Some(ngrok_tunnel);
            ...
            if let Some(mut tunnel_to_close) = active_tunnel_guard.take() {
                ...
                if let Err(e) = tunnel_to_close.close().await {
                    zoo_message_primitives::zoo_utils::zoo_logging::zoo_log(
                        zoo_message_primitives::zoo_utils::zoo_logging::ZooLogOption::Node,
                        zoo_message_primitives::zoo_utils::zoo_logging::ZooLogLevel::Error,
